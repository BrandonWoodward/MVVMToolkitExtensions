...
public static class ServiceCollectionExtensions
{
    ...
    /// view registry, enabling the view to be resolved with its <see cref="BindingContext"/> 
    ...
    /// using the <see cref="AddView{TView,TViewModel}"/> method before utilizing this method for navigation registration.
    /// </remarks>
